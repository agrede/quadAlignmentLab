...
# 3 point
denom = (x2**2-2*x1*x2+x1**2)*y3**2+(((2*x1-2*x2)*x3+2*x1*x2-2*x1**2)*y2+((2*x2-2*x1)*x3-2*x2**2+2*x1*x2)*y1)*y3+(x3**2-2*x1*x3+x1**2)*y2**2+((-2*x3**2)+(2*x2+2*x1)*x3-2*x1*x2)*y1*y2+(x3**2-2*x2*x3+x2**2)*y1**2
...
tx = (
    ...
    0.01186930013456576*(dx3*x3+dx2*x2+dx1*x1) +
    -0.007464619955641924*(dx3*y3+dx2*y2+dx1*y1))
